...
export function createTargetConfig({ mode = "accumulation", metric = "time", targetValue = 0, targetOptionId = null, sourceActionIds = [], sourceBlockId = null, descendantBlockIds = [], sourceResultFieldId = null, sourceResultTagId = null, aggregation = "latest", comparison = ">=", unitId = null, contributionScope = "direct", requiredChildTargetIds = [], period = "day", periodStyle = "calendar", rollingWindowDays = null, customStart = null, customEnd = null, timezone = "UTC", weekStartsOn = 1 } = {}) {
